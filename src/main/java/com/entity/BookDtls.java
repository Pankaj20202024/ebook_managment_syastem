...
public class BookDtls {
	...
	public String toString() {
		return "BookDtls [bookId=" + bookId + ", bookName=" + bookName + ", author=" + author + ", price=" + price
				...
				+ email + ", getBookId()=" + getBookId() + ", getBookName()=" + getBookName() + ", getAuthor()="
				+ getAuthor() + ", getPrice()=" + getPrice() + ", getBookCategory()=" + getBookCategory()
				+ ", getStatus()=" + getStatus() + ", getPhotoName()=" + getPhotoName() + ", getEmail()=" + getEmail()
