	...
	<div class="container-fluid p-3 bg-light">
		<div class="row">
			...
			<c:if test="${not empty userobj}">
				<div class="col-md-3">
					<a href="checkout.jsp" class="btn btn-dark"><i
						class="fa-solid fa-cart-shopping "></i></a> <a href="login.jsp"
						class="btn btn-success"><i class="fa-solid fa-user-plus"></i>${userobj.name}</a>
